...
I'm a Computer Science undergrad who likes building **real systems** — cloud infra, AI pipelines, and data platforms — and leading **real communities** around them.

- 🔭 Currently: **Lead @ AWS Student Builder Group – UP Cebu** + **GitHub Campus Expert** (first in the Visayas, 1% acceptance)
- 💼 Previously: **Research & Developer Intern @ ISCOLab, UP Open University** — shipped LOD opts (**+63%** metaverse perf) + a semiconductor training prototype selected as a microcredential
- 🏛️ Leadership: former **Executive Director @ UP Computer Science Guild** — ran hackathons across 10 schools, mentored 75 volunteers
- 🏆 International hackathon winner: **Huawei Developer Competition 2025 APAC 2nd Runner-Up**, **PJDSC 2024 Champion**
- 🌱 Into: cloud architecture, MLOps, system design, geospatial AI, WebXR
- 💬 Ask me about: AWS, hackathons, community building, turning class projects into shipped products

> 🎯 Portfolio that proves it: **[jpty.me](https://jpty.me)** — projects, experience, awards, contact in under 60 seconds.
...
### 🏦 [CreditPass](https://creditpass.ph) — AI credit scoring for the unbanked
Privacy-preserving credit capacity engine from telco + e-wallet telemetry. Containerized microservices on Huawei Cloud (ELB/CDN → CCE), MLOps retraining via Cloud Eye + ModelArts.
<br>`FastAPI` `Next.js` `TensorFlow` `Docker` `Huawei Cloud` `Redis`
<br>🏆 Huawei Developer Competition 2025 APAC — **2nd Runner-Up** · APRU Tech Policy Hackathon — **Honorable Mention**
<br>[🌐 Website](https://creditpass.ph) · [🎥 Demo](https://drive.google.com/file/d/1LrH2tLuHAzS4pScWeVNeZjsF3TUdcprz/view)

### 🔐 [Sabot](https://www.sabotchain.com) — P2P transaction safety layer
Immutable agreement lifecycles, multi-deliverable escrow state machines, automated fee splits + dispute flows, oracle verification before fund release.
<br>`Next.js` `TypeScript` `Solidity` `Hardhat` `Lisk Sepolia` `Supabase`
...
<br>`Next.js` `Supabase` `Prisma` `Mapbox` `LangGraph` `AWS`
...
|---|---|---|
| **Jan 2026 – Jul 2026** | 🔬 Research & Developer Intern · **ISCOLab, UP Open University** | +63% metaverse perf via LOD optimization · semi prototype → microcredential |
| **Nov 2025 – Present** | ☁️ Lead · **AWS Student Builder Group UP Cebu** | Launched campus cloud community · Community Day Cebu 2025, 200+ attendees across 8 universities |
| **Oct 2025 – Present** | 🐙 Campus Expert · **GitHub Campus Experts** | 1% acceptance · authored community assessment + inclusion framework |
| **Jun 2025 – Jun 2026** | 🏛️ Executive Director · **UP Computer Science Guild** | 50 team applications, 15 finalists, 10 schools · mentored 75 volunteers |
| **Jun 2024 – Jun 2025** | 📚 Education & Development Director · **UP Computer Science Guild** | 50+ students trained · peer tutoring reboot · Scratch outreach to 60 HS students |
...
- 🥇 **Philippine Junior Data Science Challenge 2024** — Champion (National)
- 🥇 **27th Philippine Statistics Quiz 2023** — Regional Champion (National)
- ✨ **Lisk Builders Challenge Round 3** — Honorable Mention (International)
- ✨ **APRU Tech Policy Hackathon 2025** — Honorable Mention (International)
- 🏆 **UP Cebu EXPOdition 30** — Project of the Year (Local)
...
I'm open to **internships, collaborations, and hackathons** — especially cloud infra, AI/data systems, and community-driven builds.

- 🌐 Portfolio: **[jpty.me](https://jpty.me)**
- 💼 LinkedIn: **[James Gabriel Elijah Ty](https://www.linkedin.com/in/james-gabriel-elijah-ty-89a157302/)**
- 📧 Email: **jamesty016@gmail.com**
- 📄 Resume: **[jpty.me/resume.pdf](https://jpty.me/resume.pdf)**
